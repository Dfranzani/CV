...
UDP$Bullets <- c(
  ...
  "Automatizar y estandarizar el material docente de los cursos de estadística.",
...
UTEM$Bullets <- c(
 ...
 "Diseño e implementación de flujos de tranajo para la gestión de la información."
)

tecpar <- vector("list")
tecpar$Details <- c("TecPar", "Agosto 2019 - Presente", "Científico de Datos","")
tecpar$Bullets <- c(
 "Desarrolo de modelos supervisados y no supervisados para el análisis de datos y la generación de reportes automatizados para distintos proyectos de investigación.",
 "Monitoreo y ajuste de modelos de Machine Learning y Deep Learning para la predicción y detección de patrones de distintos fenómenos (agrícola, consumo de recursos, patrones geográficos, indicadores macroeconómicos)."
)
...
sgs$Bullets <- c(
  ...
  "Consolidación de bases de datos asociadas, elaboración de indicadores operacionales, elaboración de paneles de visualización."
)
...
habilidades$Bullets <- c(
  "\\textbf{Habilidades}: Pensamiento crítico, comunicación efectiva, enseñanza-aprendizaje, visualización de datos, gestión de bases de datos, estadística/probabilidad.",
...
MG_IA = list(
 ...
 "Bullets" = "Octavo lugar de promoción (de 48). Proyecto de título en \\href{https://drive.google.com/file/d/1BKxviVojPZrCPJyTfVj79-U02q6vFHQM/view}{diseño de modelo para la detección de portonazos}."
)
...
MG_ES = list(
 ...
 "Bullets" = "Cuarto lugar de promoción (de 16). Proyecto de título en análisis de variables que influyen en SPX Index utilizando GLM."
)
